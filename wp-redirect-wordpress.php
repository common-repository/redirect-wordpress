<?php
/*
Plugin Name: Redirect WordPress
...
if (!class_exists("RedirectWordpress")) {
	class RedirectWordPress {
		/*
	...
	} // end class RedirectWordPress
	
} // end check for existance of class

// instantiate
$redirect_plugin = new RedirectWordPress();
...
if (isset($redirectit)) return false;

require_once(dirname(__FILE__) . '/redirect.class.php');

$redirectit = new RedirectWP();

add_action('wp_footer', array($redirectit, 'wp_footer'));
?>
